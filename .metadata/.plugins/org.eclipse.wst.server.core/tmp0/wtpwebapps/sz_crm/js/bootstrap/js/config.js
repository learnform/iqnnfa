...
var ip = '192.168.1.42'; //服务器 登陆IP
var tel_port = '5091'; //服务器 登陆IP
var vcc_code = 'tanlu'; //企业代码
var url = "http://192.168.1.42/manage/web/wintelapi/api";
//var url = "http://220.248.18.186:9980/manage/web/v2/wintelapi/api";
//var url = "http://192.168.1.25/wintelapi/web/api";//通过jsonp获取坐席相关信息
//var url = "http://192.168.1.36:82/wintelapi/web";//通过jsonp获取坐席相关信息
var is_load = 0; //是否自动加载；1是自动；其他非自动
