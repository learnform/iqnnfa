...
<body bgcolor="#353c44">
<div>
<center style="color: white;font-weight: 800;font-size: 30px;" >尊贵的：<span style="color: yellow;font-weight: 800;">${admin.userName}${admin.superName}</span>　　您好！！！！ 欢迎进入七彩CRM系统:</center>
