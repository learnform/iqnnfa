...
<!--     <meta name="viewport" content="width=device-width, initial-scale=1.0"> -->
    <!-- Bootstrap -->
    <link href="${pageContext.servletContext.contextPath}/js/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen" />
    <link href="${pageContext.servletContext.contextPath}/js/bootstrap/css/font-awesome.min.css" rel="stylesheet" media="screen" />
<!-- </head>
<body> -->
<object  width="0" height="0" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" id="wincall" align="middle">
    ...
    <embed src="${pageContext.servletContext.contextPath}/wincall400sss.swf" width="0" height="0" id="wincall_emded"  quality="high" name="wincall" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>
<script>
$("#ztth_callouter_num").val(document.getElementById("phone").value);
$("#ztth_callerId_num").val(document.getElementById("callerId").value);
</script>
<div class="container-fluid">
    <div class="row-fluid">
        <div class="pull-left" id='toolbar'>
            ...
            <button type="button" class="btn" id='ztth_callouter_btn' disabled="disabled" onclick="clickOutNum()">
...
<div id="callinner_content" style="display:none">
 <form class="form-horizontal">
    <div class="control-group">
		...
		<div class="controls">
			<input type="text" id="ztth_pc_user_num" placeholder="" value="15909346841" >
		</div>
	</div>
	<div class="control-group">
    ...
    <form class="form-horizontal">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <input type="text" id="ztth_callerId_num">
            </div>
        </div>
		<!--
        ...
        <div class="control-group">
            <div class="controls">
                <button type="button" class="btn" id='ztth_callouter_btn' onclick="clickOutNum()"> 呼叫</button>
...
<!-- <script src="${pageContext.servletContext.contextPath}/js/bootstrap/js/jquery.js" ></script> -->
<script src="${pageContext.servletContext.contextPath}/js/bootstrap/js/config.js" ></script>
<script src="${pageContext.servletContext.contextPath}/js/bootstrap/js/jquery.wincall.js" ></script>
<script src="${pageContext.servletContext.contextPath}/js/bootstrap/js/app.js" ></script>
<script src="${pageContext.servletContext.contextPath}/js/bootstrap/js/bootstrap.min.js"></script>
<!-- </body>
</html> -->