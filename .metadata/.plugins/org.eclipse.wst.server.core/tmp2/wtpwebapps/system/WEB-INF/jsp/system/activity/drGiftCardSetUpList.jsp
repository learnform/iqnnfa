	...
	<table id="drGiftCardSetUpList" title="兑换券管理" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'code'" width="12%">礼品券编号</th>
				<th data-options="field:'channelName'" width="8%">渠道名称</th>
				<th data-options="field:'channelCode'" width="8%">渠道编号</th>
				<th data-options="field:'status'" formatter="formatStatus" width="5%">状态</th>
				<th data-options="field:'startTime'" formatter="formatDateBoxFull" width="12%">活动开始时间</th>
				<th data-options="field:'endTime'" formatter="formatDateBoxFull" width="12%">活动结束时间</th>
				<th data-options="field:'totalQty'" styler="styleColor" width="8%">兑发放总量</th>
				<th data-options="field:'useQty'" styler="styleColor" width="8%">已发数量</th>
				<th data-options="field:'validQty'" styler="styleColor" width="8%">未发数量</th>
				<th data-options="field:'failureQty'" styler="styleColor" width="8%">失效数量</th>
				<th data-options="field:'onceQty'" styler="styleColor" width="5%">单送数量</th>
				<th data-options="field:'addName'" width="8%">添加人</th>
				<th data-options="field:'addTime'" formatter="formatDateBoxFull" width="12%">添加时间</th>
				<th data-options="field:'updateName'" width="8%">修改人</th>
				<th data-options="field:'updateTime'" formatter="formatDateBoxFull" width="12%">修改时间</th>
