		...
		<div title="产品信息" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px">
			...
			<table id="productInfo" align="center" cellspacing="1" cellpadding="1" style="width:auto;">
				...
				<tr>
					...
					<td colspan="2">
						<input id="productRate" name="rate" value="${drProductInfo.rate}" type="text" class="easyui-numberbox" data-options="required:true,min:0,max:12,precision:2"/>%
					</td>
				...
				<tr>
					...
					<td colspan="2">
						<input id="productLeastaAmount" name="leastaAmount" value="${drProductInfo.leastaAmount}" type="text" class="easyui-numberbox" data-options="required:true,min:0,max:100000"/>元
					</td>
...
<!-- 					</td> -->
				...
				<tr>
					...
					<td align="left">
						<input id="productIsRepair" name="isRepair" type="checkbox" value="1" <c:if test="${drProductInfo.isRepair == 1}"> checked="checked" </c:if>/>可否补标
					</td>
				</tr>
				<tr>
