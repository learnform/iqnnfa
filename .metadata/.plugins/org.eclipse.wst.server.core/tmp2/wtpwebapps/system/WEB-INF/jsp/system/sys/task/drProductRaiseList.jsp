...
<body>
	<table id="drProductRaiseList" title="手动计息" 
	class="easyui-datagrid" style="height:99%;width:99.9%"
	data-options="singleSelect:true,
	    fitColumns:true, url: '../task/drProductRaiseList.do',
...
<script type="text/javascript">
	...
	$('#confirmPassWord').click(function(){
		$.ajax({
          	url: "${apppath}/task/chcekPassWord.do",
            type: 'POST',
	...
	function formatOper(val,row,index){  
			return	'<a href="#" class="btn l-btn l-btn-small" onclick="toShowProductInfoBtn('+index+')">查看</a>'+"   "+
					'<a href="#" class="btn l-btn l-btn-small" onclick="raiseByHandsBtn('+index+')">手动计息</a>';
	} 
