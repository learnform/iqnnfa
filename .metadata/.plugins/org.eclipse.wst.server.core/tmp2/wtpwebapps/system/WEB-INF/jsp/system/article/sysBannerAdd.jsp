...
<form id="addSysBannerForm" enctype="multipart/form-data">
	<table>
		...
		<tr>	
			<td>
				版本号控制:
				低于<input id="minVersion" type="text" name="minVersion" size="10" class="easyui-textbox" />
				和高于<input id="maxVersion" type="text" name="maxVersion" size="10" class="easyui-textbox"/>的版本不显示
			</td>
		</tr>
		<tr>	
			<td>
		...
		<tr>	
			<td>
				广告位置:
				<select id="code" name="code" style="width:130px;" class="easyui-combobox">
