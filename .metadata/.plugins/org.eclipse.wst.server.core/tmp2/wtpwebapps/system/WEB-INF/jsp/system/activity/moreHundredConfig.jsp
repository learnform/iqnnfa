...
<body>
	<table id="configList" title="奖池配置100W以上" 
	class="easyui-datagrid" style="height:99%;"
	data-options="singleSelect:true,
	    fitColumns:true,url: '../luckDraw/luckDrawConfig.do?flag=moreHundred',
...
function editConfig(index){
	...
	$("#update").window({
		title:"奖池配置编辑页面",
		href:"../luckDraw/luckDrawConfigEdit.do?configId="+configId+"&luckDrawId="+luckDrawId+"&flag=moreHundred"
	});
	$("#update").window("open");
}
