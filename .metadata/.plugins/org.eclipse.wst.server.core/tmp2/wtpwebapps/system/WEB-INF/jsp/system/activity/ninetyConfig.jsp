...
<body>
	<table id="configList" title="奖池配置80W-90W" 
	class="easyui-datagrid" style="height:99%;"
	data-options="singleSelect:true,
	    fitColumns:true,url: '../luckDraw/luckDrawConfig.do?flag=ninety',
...
function editConfig(index){
	...
	$("#update").window({
		title:"奖池配置编辑页面",
		href:"../luckDraw/luckDrawConfigEdit.do?configId="+configId+"&luckDrawId="+luckDrawId+"&flag=ninety"
	});
	$("#update").window("open");
}
