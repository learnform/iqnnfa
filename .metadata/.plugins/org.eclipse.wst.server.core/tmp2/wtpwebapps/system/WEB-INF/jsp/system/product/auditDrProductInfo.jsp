			...
			<tr>
				...
				<td colspan="2">
						<select name="intermediary" style="width: 172px" class="easyui-combobox" disabled="disabled"> 
								<c:if test="${drProductInfo.riskLevel==1}">
									<option value="${drProductInfo.riskLevel}" selected="selected">低风险</option>
								</c:if>
								<c:if test="${drProductInfo.riskLevel==2}">
									<option value="${drProductInfo.riskLevel}" selected="selected">较低风险</option>
								</c:if>
								<c:if test="${drProductInfo.riskLevel==3}">
									<option value="${drProductInfo.riskLevel}" selected="selected">中等风险</option>
								</c:if>
								<c:if test="${drProductInfo.riskLevel==4}">
									<option value="${drProductInfo.riskLevel}" selected="selected">一定风险</option>
								</c:if>
						</select>
					</td>
...
<!-- 				</td> -->
			...
			<tr>
				...
				<td colspan="2">
					<input id="pcUrl" name="pcUrl" value="${drProductInfo.pcUrl}" type="text" class="easyui-textbox" style="width:350px;" disabled="disabled" data-options="validType:'maxLength[50]'"/>
				</td>
			</tr>
			<tr>
				<td align="left">移动跳转：</td>
				<td colspan="2">
					<input id="appUrl" name="appUrl" value="${drProductInfo.appUrl}" type="text" class="easyui-textbox" style="width:350px;" disabled="disabled" data-options="validType:'maxLength[50]'"/>
				</td>
			</tr>
			<tr>
				<td align="left">
				...
				<td align="left">
					...
					<input name="isRepair" type="checkbox" value="1" <c:if test="${drProductInfo.isRepair == 1}"> checked="checked" </c:if> disabled="disabled"/>可否补标
				</td>
			</tr>
			<tr>
				<td align="left">
					<input id="immediately" name="immediately" type="checkbox" value="1" <c:if test="${drProductInfo.immediately == 1}"> checked="checked" </c:if>  disabled="disabled"/>红包是否实时返现
				</td>
			</tr>
			<tr>
