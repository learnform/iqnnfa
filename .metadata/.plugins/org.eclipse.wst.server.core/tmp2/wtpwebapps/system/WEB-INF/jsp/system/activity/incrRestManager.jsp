...
<body>
	<table id="incrRestList" title="加息券管理" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'productDeadline'" width="6%">产品期限</th>
	...
	<div id="incrRestTools" style="padding:5px;height:750">
		<form id="incrRestForm">
			...
			加息额度：<input class="easyui-numberbox" id="searchRaisedRates" name="raisedRates" size="15" style="width:150px" />&nbsp;&nbsp; 
			...
			<table align="center">
				...
				<tr>
					...
					<td style="width:120px">
						<input id="addDeadline" name="deadline" class="easyui-textbox" style="width:110px"  data-options="required:true" />天
					</td>
					<td>产品期限≥:</td>
					<td style="width:120px">
						<input id="addProductDeadline" name="productDeadline" class="easyui-textbox" style="width:110px"  data-options="required:true" />天
					</td>
				</tr>
			</table>
		</form>
