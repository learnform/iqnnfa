...
<input name="id" type="hidden" value="${sysBanner.id}" />
	<table>
		...
		<tr>	
			<td>
				版本号控制:
				低于<input id="minVersion" type="text" name="minVersion" value="${sysBanner.minVersion}" size="10" class="easyui-textbox" />
				和高于<input id="maxVersion" type="text" name="maxVersion" value="${sysBanner.maxVersion}" size="10" class="easyui-textbox"/>的版本不显示
			</td>
		</tr>
		<tr>	
			<td>
