...
<div id="${tabid }">
	<form id="updateDrClaimsInfoForm" enctype="multipart/form-data">
		...
		<div title="<center>企业客户基本信息</center>" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px" data-options="collapsible:true">
			<table align="center" cellspacing="1" cellpadding="1" style="width:auto;">
				...
				<tr>
					...
					<td>
						<input name="drClaimsCustomer.name" value="${drClaimsCustomer.name}" type="text" class="easyui-textbox" data-options="validType:'maxLength[10]'"/>
					</td>
					<td align="left">性别：</td>
					<td>
					...
					<td>
						<input name="drClaimsCustomer.phone" value="${drClaimsCustomer.phone}" type="text" class="easyui-textbox" data-options="validType:'maxLength[11]'"/>
					</td>
				</tr>
				<tr>
		...
		<div title="<center>贷款项目基本信息</center>" class="easyui-panel" style="width:100%;height:auto;padding:10px;margin-bottom: 10px" data-options="collapsible:true">
			<table align="center" cellspacing="1" cellpadding="1" style="width:auto;">
				<tr>
					...
					<td>
						<input name="loanUse" value="${drClaimsLoan.loanUse}" type="text" class="easyui-textbox" data-options="validType:'maxLength[250]'"/>
					</td>
				</tr>
				<tr>
					<td align="left">贷款金额(万元)：</td>
					<td>
						<input name="loanAmount" value="${drClaimsLoan.loanAmount}" class="easyui-numberbox" data-options="min:0,max:10000,precision:6"/>
					</td>
					<td align="left">币种：</td>
					<td>
				...
				<tr>
					...
					<td colspan="5">
						<input name="bankNo" value="${drClaimsLoan.bankNo}" style="width: 750px" type="text" class="easyui-textbox" data-options="validType:'maxLength[50]'"/>
					</td>
				</tr>
				<tr>
		...
		<div id="projectUpdBtn">
			<a href="javascript:void(0)" class="icon-add" onclick="updProject();"></a>
		</div>
		<div id="picAddBtn">
