...
public class Utils {
	...
	public static String getQuartzTime(Date date){
		...
		return calendar.get(calendar.SECOND)+" "+calendar.get(calendar.MINUTE)+" "+calendar.get(calendar.HOUR_OF_DAY)+
	 ...
	 *            ,如:yyyy-MM-dd,MM/dd/yyyy. 根据上述输入字符型日期,此处应填写的规则是:yyyy-MM-dd
	 */
	public static String getDayNumOfDate(int dayNum, String format) {
		int day = -dayNum;
		Calendar cal = Calendar.getInstance();
	 ...
	 * @return
	 */
	public static String getMinuteNumOfAppointDate(Date appointDate, int minute,
												String format) {
		Calendar cal = Calendar.getInstance();
	 ...
	 *            ,如:yyyy-MM-dd,MM/dd/yyyy. 根据上述输入字符型日期,此处应填写的规则是:yyyy-MM-dd
	 */
	public static Date getMonthNumOfMonth1(int monthNum, int dateNum, String format) {
		Calendar cal = Calendar.getInstance();
		cal.add(Calendar.MONTH, -monthNum);
		cal.add(Calendar.DATE, -dateNum);
		return cal.getTime();
	...
	public static Date getMonthNumOfMonth3(Date date,int monthNum) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(Calendar.MONTH, -monthNum);
		return cal.getTime();
...
//	}
    ...
    * @return 拼音
	...
	public static void main(String [] args){
		System.out.println(formatMoney("200124412.2",2));
	}
